...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group">
			...
			<br>
			<input type="text" name='clientsId' value={!! $commande->clients_Id !!} readonly>
		</div>
		<div class="form-group">
		...
		<h3 class="panel-title"><strong>Liste des items de la commande</strong></h3>
			...
			@foreach($data as $produit)
				<tr>
					<td><input type='text' name={!! $produit[0] !!} value={!! $produit[1] !!} readonly></td>
					<td><input type='text' name={!! $produit[2] !!} value={!! $produit[3] !!} readonly></td>
